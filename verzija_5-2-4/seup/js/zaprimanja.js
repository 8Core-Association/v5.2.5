            ...
            submitZaprimanjeBtn.addEventListener('click', function(e) {
                ...
                if (dokumentFile && dokumentFile.files && dokumentFile.files[0]) {
                    ...
                    if (fileSize > maxFileSize) {
                        showToast(`Dokument je prevelik (${fileSizeMB} MB). Maksimalna veličina je 150 MB. Molimo povećajte PHP limite ili smanjite veličinu fajla.`, 'error');
                        return;
                    }
                }
                ...
                if (potvrdaFile && potvrdaFile.files && potvrdaFile.files[0]) {
                    ...
                    if (fileSize > maxFileSize) {
                        showToast(`Potvrda je prevelika (${fileSizeMB} MB). Maksimalna veličina je 150 MB. Molimo povećajte PHP limite ili smanjite veličinu fajla.`, 'error');
                        return;
                    }
                }
