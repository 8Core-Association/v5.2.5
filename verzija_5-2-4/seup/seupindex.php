...
$cacheBust = time();
print '<link href="/custom/seup/css/seup-modern.css?v=' . $cacheBust . '" rel="stylesheet">';
print '<link href="/custom/seup/css/setup-modal.css?v=' . $cacheBust . '" rel="stylesheet">';
print '<link href="/custom/seup/css/notification-bell.css?v=' . $cacheBust . '" rel="stylesheet">';
...
print '}';
print '</script>';
print '<script src="/custom/seup/js/seup-modern.js?v=' . $cacheBust . '"></script>';
print '<script src="/custom/seup/js/setup-modal.js?v=' . $cacheBust . '"></script>';
print '<script src="/custom/seup/js/notification-bell.js?v=' . $cacheBust . '"></script>';
